...
export default function defaultRowRenderer({
    ...
    if (rowData && rowData.sysMeta) {
        ...
        const MARGIN_LEFT_PLUS = 20;
        const marginLeftPlus = rowData.sysMeta.level > 0 ? rowData.sysMeta.level * MARGIN_LEFT_PLUS + 10 : 10;

        var padLeftStyle = { marginLeft: marginLeftPlus + 'px' };
